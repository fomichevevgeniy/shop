...
# Создать модель Избранное, которое знает Продукт и пользователя
# Создать вьюшку, которая будет показывать все избранные пользователя (похожа на категорию)
# Повесить ссылку на сердечко наверху
# Создать вьюшку для добавления или удаления товара из избранного
# Повесить на сердечко в карточке товара
# Если товар в избранном, сделать сердце активным

# Рассылку на почту пользователям
...
'''Сделать страницы для корзины и оформления заказа
Сделать логику для покупки только для зарегестрированных пользователей
Подключить оплату - stripe

Пагинация - переключение страниц - страницы категории
Автоперевод страниц и моделей
Выбор города по селекту

Сдача своих проектов (час)
Ответы на вопросы
Материалы, где еще получить знания
